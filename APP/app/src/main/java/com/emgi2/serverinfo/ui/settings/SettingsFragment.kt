package com.emgi2.serverinfo.ui.settings
...
import com.emgi2.serverinfo.DarkMode
import com.emgi2.serverinfo.R
...
class SettingsFragment : Fragment() {
    ...
    private fun fetchDataAndUpdateViews() {
        val jsonUrl = "https://raw.githubusercontent.com/marek-guran/linux-server-info/main/update.json"
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                try {
                    ...
                    return@withContext JSONObject(stringBuilder.toString())
                } finally {
